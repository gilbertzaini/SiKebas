    ...
    <x-form action="{{ route('login') }}">
        <div class="container d-flex justify-content-center align-items-center min-vh-100">
            <div class="row border bg-white shadow-lg box-area" style="border-radius: 12pt" >
                <h2 class="text-center d-flex justify-content-center my-2">Sikebas</h2>
                ...
                <div class="col-md-6 right-box">
                    ...
                    <div class="row align-items-center mt-4">
                        ...
                        <div class="d-flex justify-content-center mb-5">
                            <button type="submit" class="btn btn-success d-flex mt-2"><p class="py-auto my-auto" style="font-family: Calibri Light">Masuk</p></button>
                        </div>
                    </div>
                    <div id="bulet2"></div>
                </div>
